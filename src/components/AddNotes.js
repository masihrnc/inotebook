...
<div className="mb-3">
  ...
  <input type="text" className="form-control" id="title" name="title" value={notes.title} aria-describedby="emailHelp"
...
<button type="submit" className="btn btn-primary" onClick={handleClick}>AddNotes</button>
</form>
